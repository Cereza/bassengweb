...
<!--
	The view file Søk which gets loaded when a user has admin rights.
	Much like the regular Søk, this page allows it's users to select
	criteria after which data from the DB gets selected and put into
	a readable format. Addition to admin is that they can edit and delete
	these results.
-->
	...
	<div class="container" >
		<div class="row" >
			<div class="col-lg-12" >
				...
				<h2><span class="glyphicon glyphicon-search"></span> Admin Søk </h2>
			...
			@foreach($data as $dataItem)
				<tr>
					...
					@endforeach
                  	...
                  	<td><a href="{{{ URL::route('edit_data' ,array($dataItem->id)) }}}"><span class="glyphicon glyphicon-edit"></span></a> </td>  
					<td><a href="{{{ URL::route('delete_confirm', array($dataItem->id)) }}}"><span class="glyphicon glyphicon-trash"></span></a </td>
				</tr>
			@endforeach
					</table>
     <div id="center">
